        ...
        for event in events:
            ...
            detections.append(make_detection(
                ...
                0.86 if malicious_verdict else 0.45,
                {
                    ...
                    "sandbox_status": metadata.get("sandbox_status"),
                    "sandbox_verdict": metadata.get("sandbox_verdict"),
                    "sandbox_confidence": metadata.get("sandbox_confidence"),
                    "sandbox_source": metadata.get("sandbox_source"),
                    "sandbox_analysis_id": metadata.get("sandbox_analysis_id"),
                    "sandbox_findings": metadata.get("sandbox_findings"),
